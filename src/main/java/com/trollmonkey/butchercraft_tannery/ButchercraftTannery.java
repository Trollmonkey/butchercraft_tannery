...
public class ButchercraftTannery {
    ...
    // Creates a new Block with the id "butchercrafttannery:example_block", combining the namespace and path
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = BLOCKS.registerSimpleBlock("example_block", BlockBehaviour.Properties.of().mapColor(MapColor.STONE));
    // Creates a new BlockItem with the id "butchercrafttannery:example_block", combining the namespace and path
